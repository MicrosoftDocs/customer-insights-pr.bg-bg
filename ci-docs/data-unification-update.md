...
1. След като направите промените си, изберете следващата си опция:
   ...
   - За да актуализирате унифицирания профил на клиента (със или без зависимости), вижте [Изпълнение на актуализации в потребителския профил](#run-updates-to-the-unified-customer-profile) на клиента.
   - За да оцените качеството на вашите съответстващи условия, без да актуализирате унифицирания профил, вижте [Изпълнение на условията за](#run-matching-conditions) съответствие. **Опцията "Изпълнение на съответстващи условия" не се показва само** за един обект.
...
1. Изберете **Напред**, за да направите промени в съответстващите условия, или изберете **Запазване и затваряне** и връщане към [Актуализиране на настройките за](#update-the-unification-settings) обединение.
...
1. От страницата Обединение на **данни** > **изберете** Изпълнение само **на съответстващи условия.**
   ...
   **Дублираните** записи и **плочките** "Съвпадащи условия" показват **"Опашка"** или **"Обновяване**".
...
1. От страницата Обединение **на** > **данни** изберете:
   ...
   - **Унифициране на профили** на клиенти: Актуализира унифицирания обект за клиентски профил, без да оказва влияние върху зависимостите (като например обогатявания, сегменти или мерки). Зависимите процеси не се изпълняват, но ще бъдат обновени, както [е определено в графика](system.md#schedule-tab) за обновяване.

   - **Унифициране на клиентски профили и зависимости**: Актуализира унифицирания профил и всички зависимости. Всички процеси се пренавират автоматично. След като всички процеси надолу по веригата са приключили, профилът на клиента отразява актуализираните данни.

   **Плочките Дублирани** записи, **Съвпадащи условия** и **Единни клиентски полета** показват **Queued** или **Refreshing**.
