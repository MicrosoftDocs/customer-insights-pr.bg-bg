...
- **Експортирането** на данни ви позволява да експортирате всеки тип обект, наличен в "Аналитични данни за клиенти". Обектите, които изберете за експортиране, се експортират с всички полета с данни, метаданни, схеми и подробности за картографиране.
- **Експортирането** на сегмент ви позволява да експортирате обекти от сегменти от "Аналитични данни за клиенти". За отделните потребители (B-to-C) сегментите представляват списък с профили на клиенти. За бизнеса (B-to-B [) сегментите могат да представляват списък с партньори или контакти](segment-builder.md#create-a-new-segment-with-segment-builder). При конфигуриране на експортирането избирате включените полета с данни, в зависимост от целевата система, в която експортирате данни.
...
**Сегментен износ в среди за бизнес сметки (B-to-B)**  
- Сегменти в контекста на среди за бизнес акаунти са изградени върху обекта на *акаунта* или *обекта на контакта*. За да експортирате сегменти на акаунт такъв, какъвто е, целевата система трябва да поддържа чисти сегменти на акаунта. Това е така за [LinkedIn](export-linkedin-ads.md), когато изберете **фирма** опция, докато дефинирате експорта.
- Всички други целеви системи изискват полета от субекта за контакт.
- С два типа сегменти (контакти и акаунти) Customer Insights автоматично идентифицира кой тип сегменти отговарят на условията за експортиране въз основа на целевата система. Например за насочена към контакт целева система като Mailchimp, Customer Insights ви позволява само да изберете сегменти за контакт, които да експортирате.
...
- За отделни клиенти ще видите действителния брой членове на сегмента, когато изберете сегмент за експортиране. Ще получите предупреждение, ако даден сегмент е твърде голям. 
- За бизнес акаунтите ще видите броя на партньорите или контактите в зависимост от сегмента. Ще получите предупреждение, ако сегментът е твърде голям. Превишаването на границите на целевите системни резултати ще пропусне експортирането.
...
> [!TIP]
> Минимизирайте времето за обработка на износа на сегмент със следните най-добри практики:
> - Разпределете обектите на сегмента в целия мътиплен износ.
> - Избягвайте да насрочвате всички износи едновременно. Оставете 30 минути или един час между планираното време на всеки износ.
...
### <a name="segment-not-eligible-for-export"></a>Сегмент, който не отговаря на условията за експортиране

**Проблем** В рамките на среда на бизнес акаунти вашият износ е неуспешно със съобщението за грешка: "Следният сегмент не отговаря на условията за това местоназначение за експортиране: "{име на сегмент}". Моля, изберете само сегменти от тип ContactProfile и опитайте отново."

**Средите на "Аналитични данни за клиенти за разделителна способност** " за бизнес акаунти бяха актуализирани, за да поддържат сегменти за контакти в допълнение към сегментите на профила. Поради тази промяна износът, нуждаещ се от данни за контакт, работи само със сегменти въз основа на контакти.

1. [Създайте сегмент въз основа на контакти,](segment-builder.md) който съответства на вашия използван преди това сегмент.

1. След като този контактен сегмент се изпълни, редактирайте съответния експортиране и изберете новия сегмент.

1. Изберете **Запиши**, за да запишете конфигурацията или **Запиши и изпълнете**, за да тествате този износ веднага.
