...
- **Експортирането** на сегмент ви позволява да експортирате обекти от сегменти от "Аналитични данни за клиенти". Сегментите представляват списък с потребителски профили. Когато конфигурирате експортирането, избирате включените полета с данни в зависимост от целевата система, в която експортирате данни. 
...
Повечето опции за експортиране поддържат и двата типа среди. Експортирането на сегменти към различни целеви системи има специфични изисквания. Най -общо казано, член на сегмент, потребителският профил, съдържа информация за контакт. Въпреки че това обикновено е така за сегменти, изградени върху индивидуални потребители (B-to-C), не е задължително да е така и за сегменти, базирани на бизнес акаунти (B-to-B). 
