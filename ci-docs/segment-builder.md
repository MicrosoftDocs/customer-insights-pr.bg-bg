---
title: Създаване на сегменти
description: Създайте сегменти от клиенти, за да ги групирате въз основа на различни атрибути с помощта на конструктор на сегменти или бързи сегменти.
ms.date: 03/25/2022
