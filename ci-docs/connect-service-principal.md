...
Отидете на портала на Azure, за да предоставите разрешения на главницата на услугата за акаунта за съхранение, който искате да използвате в "Аналитични данни за клиенти". Една от следните роли трябва да бъде присвоена на акаунта или контейнера за съхранение:

|Идентификационни данни|Изисквания|
|----------|------------|
|Влезли в момента потребител|**Роля**: Съхранение Blob четец на данни, съхранение blob сътрудник или съхранение Blob собственик.<br>**Ниво**: Разрешенията могат да се предоставят в акаунта за съхранение или контейнера.</br>|
|Директор на услугата за прозрения на клиенти -<br>Използване Azure Data Lake Storage като източник на данни</br>|Опция 1<ul><li>**Роля**: Съхранение Blob четец на данни, Съхранение Blob данни сътрудник или съхранение Blob данни собственик.</li><li>**Ниво**: Разрешенията следва да се предоставят в акаунта за съхранение.</li></ul>Опция 2 *(без споделяне на Услугата Главен достъп до акаунта за съхранение)*<ul><li>**Роля 1**: Съхранение Blob четец на данни, съхранение blob данни сътрудник или съхранение Blob данни собственик.</li><li>**Ниво**: Разрешенията следва да се предоставят на контейнера.</li><li>**Роля 2**: Съхранение Blob данни делегатор.</li><li>**Ниво**: Разрешенията следва да се предоставят в акаунта за съхранение.</li></ul>|
|Директор на услугата за прозрения на клиенти - <br>Използване Azure Data Lake Storage като изход или местоназначение</br>|Опция 1<ul><li>**Роля**: Съхранение Blob данни сътрудник или съхранение Blob собственик.</li><li>**Ниво**: Разрешенията следва да се предоставят в акаунта за съхранение.</li></ul>Опция 2 *(без споделяне на Услугата Главен достъп до акаунта за съхранение)*<ul><li>**Роля**: Съхранение Blob данни сътрудник или съхранение Blob собственик.</li><li>**Ниво**: Разрешенията следва да се предоставят на контейнера.</li><li>**Роля 2**: Съхранение Blob делегатор.</li><li>**Ниво**: Разрешенията следва да се предоставят в акаунта за съхранение.</li></ul>|
