...
ms.locfileid: "8755485"
---
# <a name="customer-activities"></a>Дейности на клиента

Комбинирайте дейности на клиент от [различни източници на данни](data-sources.md) в Dynamics 365 Customer Insights. Създайте времева линия, която изброява дейностите хронологично. Включете времевата линия в приложенията на Dynamics 365 с решението за добавка ["Карта на](customer-card-add-in.md) клиент".
...
Ако клиент е участвал в конфигурирана дейност, ще я намерите в секцията Хронология **на** дейността.
