...
За да добавите потребители, отидете в [Microsoft 365 центъра](https://admin.microsoft.com) за администриране с помощта на профила на администратор на пробния период. Следвайте [указанията на центъра за администриране](/microsoft-365/admin/add-users/add-users), за да добавите потребители до лимита на пробния лиценз. Ако потребителят, който добавяте, вече има Microsoft 365 акаунт, им присвоете подходяща права за достъп в пробната орг. За повече информация вижте [Присвояване на права за достъп на потребител](/power-platform/admin/create-users-assign-online-security-roles#assign-a-security-role-to-a-user).
