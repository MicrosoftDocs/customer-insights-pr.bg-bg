...
ms.locfileid: "9245790"
---
# <a name="custom-machine-learning-models"></a>Персонализирани модели за машинно обучение

> [!NOTE]
> Поддръжката за машинно обучение Studio (класически) ще приключи на 31 август 2024 г. Препоръчваме ви да преминавате към Azure машинно обучение [до](/azure/machine-learning/overview-what-is-azure-machine-learning) тази дата.
>
...
1. За всички **Входни данни на уеб услуга** изберете съответния **Обект** от Customer Insights и изберете **Напред**.
   > [!NOTE]
...
1. Изберете съвпадащия атрибут от падащия списък **ИД на клиент в резултатите**, който идентифицира клиенти и изберете **Записване**.
...
1. Ще видите екрана **Работният поток е запазен** с подробности за работния поток.    
   Ако сте конфигурирали работен поток за машинно обучение тръбопровод на Azure, "Аналитични данни за клиенти" се прикачи към работната област, съдържаща тръбопровода. "Аналитични данни за клиенти" ще получи **роля на сътрудник** в работната област на Azure.
...
1. На **страницата Персонализирани модели** изберете вертикалното елипса (&vellip;) в графата **Действия** до работен поток, който сте създали преди това, и изберете **Редактиране**.
...
1. За всеки **вход** за уеб услуга можете да актуализирате съответстващия **обект** от "Аналитични данни за клиенти". След това изберете **Напред**.
...
1. На **страницата Персонализирани модели** изберете вертикалното елипса (&vellip;) в **колоната Действия** до работен поток, който сте създали преди това.

1. Изберете **Изпълнение**.

Вашият работен поток се изпълнява автоматично и с всяко планирано обновяване. Научете повече за [настройката на планирано обновяване](schedule-refresh.md).
