...
> - В момента може да се конфигурира само един обект в хронологията на трансакциите. Ако има няколко обекта на покупка, обединете ги в Power Query преди приемането на данни.
...
1. Прегледайте всички грешки. Има няколко вида грешки, които могат да възникнат, и те описват кое състояние е причинило грешката. Например грешка, че няма достатъчно данни за точно прогнозиране, обикновено се разрешава чрез зареждане на повече данни в Customer Insights.
