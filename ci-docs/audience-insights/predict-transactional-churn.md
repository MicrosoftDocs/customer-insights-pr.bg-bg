---
title: Прогноза за отлив в трансакциите
...
ms.locfileid: "7643345"
---
# <a name="transaction-churn-prediction-preview"></a>Прогноза за отлив в трансакциите (преглед)
...
> [!TIP]
> Изпробвайте урока за изхвърляне на транзакция прогноза, като използвате примерни данни: [Примерно ръководство за отхвърляне на транзакция прогноза (преглед)](sample-guide-predict-transactional-churn.md).
...
- (По избор) Данни за вашите клиенти:
    - Тези данни трябва да се срещат рядко и трябва да се подравняват към по -статични атрибути, за да се гарантира, че моделът се представя най -добре.
...
1. Съпоставете семантичните атрибути с полетата, които са необходими за стартиране на модела. Ако полетата по-долу не са попълнени, конфигурирайте връзката от вашия обект в историята на покупките към обекта *клиент*.
...
### <a name="provide-an-optional-list-of-benchmark-accounts-business-accounts-only"></a>Предоставяне на незадължителен списък на сравнителни сметки (само за бизнес сметки)
