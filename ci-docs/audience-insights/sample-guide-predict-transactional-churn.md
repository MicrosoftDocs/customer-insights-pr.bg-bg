...
---
# <a name="transactional-churn-prediction-preview-sample-guide"></a>Примерно ръководство за прогноза за оттегляне на трансакции (преглед)
...
1. В полето „Име“ в десния прозорец преименувайте вашия източник на данни от **Запитване** на **eCommercePurchases**.
...
1. Изберете **История на покупките (задължително)** и изберете **Добавете данни** за история на абонамента.
