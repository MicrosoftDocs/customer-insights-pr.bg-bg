...
Това ръководство ще ви обясни пример от край до край на прогноза транзакционно оттегляне в Customer Insights, използвайки данните, предоставени по-долу. Всички данни, използвани в това ръководство, не са реални клиентски данни и са част от Contoso набор от данни, намерен в *Демонстрация* среда в рамките на вашия абонамент за Customer Insights.

## <a name="scenario"></a>Сценарий

Contosoе компания, която произвежда висококачествени кафе и кафе машини, които продават чрез своя уеб сайт Contoso Coffee. Целта им е да знаят кои клиенти, които обикновено купуват редовно техните продукти, ще спрат да бъдат активни клиенти през следващите 60 дни. Знаейки кой е от техните клиенти **вероятно да се оттегли**, може да им помогне да спестят маркетингови усилия, като се съсредоточат върху запазването им.
...
1. Актуализирайте типа данни за колоните, изброени по-долу:
   ...
   ![Преобразуване на DoB в дата.](media/ecommerce-dob-date.PNG "трансформира датата на раждане в дата")
