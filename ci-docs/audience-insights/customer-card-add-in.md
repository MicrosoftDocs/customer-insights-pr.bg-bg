...
1. Изберете опцията **Уеб** за контролата. За контролата за допълване изберете кой тип допълване искате да се покаже чрез конфигуриране на полето **enrichmentType**. Трябва да добавите отделна контрола за допълване за всеки тип допълване.
