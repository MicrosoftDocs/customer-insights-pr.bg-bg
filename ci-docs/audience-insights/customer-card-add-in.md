...
- За да могат вашите данни на Dynamics 365 да се съпоставят с прозренията на аудиторията, клиентските профили, които трябва да бъдат [погълнати от приложението Dynamics 365 с помощта на Common Data Service конектор](connect-power-query.md).
