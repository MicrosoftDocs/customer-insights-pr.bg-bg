...
Организациите създават йерархии на акаунти, за да управляват по -добре акаунтите и техните взаимоотношения помежду си. Възможността за анализиране на аудиторията поддържа йерархии на акаунт родител-дете, които вече съществуват в погълнатите клиентски данни. Например сметки от Dynamics 365 Sales. Тези йерархии могат да бъдат конфигурирани на **Релации** страница в статистика за аудиторията, в раздела йерархия на профила.
