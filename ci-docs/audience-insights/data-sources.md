...
---
# <a name="overview-about-data-sources"></a>Общ преглед на източниците на данни
...
Изберете **Опресняване на състоянието** за преглед на повече подробности за състоянието на опресняване, включително подробности за грешки и актуализации на процеса надолу по веригата.
