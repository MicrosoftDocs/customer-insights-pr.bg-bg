...
Като потребител на статистика за аудиторията, вероятно имате серия от [създадени мерки](measures.md), които помагат да се проследят вашите ключови показатели за ефективност (KPI). Важно е да разберете как определени атрибути влияят на този KPI, за да създават сегменти и да провеждат силно насочена кампания.   
...
Категоричен атрибут като *удовлетвореността на клиентите* тъй като основният атрибут води до предложени сегменти, които имат по-висок или по-нисък процент клиенти, принадлежащи към определена категория, в сравнение с процента на всички клиенти, принадлежащи към същата категория. Например *удовлетвореността на клиентите* е избран за основен атрибут и се състои от три категории (*Ниска*, *Среден* и *Високо*). За всяка категория ще бъдат предложени сегменти, които имат значително по-висок или по-нисък процент клиенти, принадлежащи към тази категория, в сравнение с дела на всички клиенти в същата категория. Ако 22% от всички клиенти имат *Висока* удовлетвореност, тогава само сегменти, които имат значително по-висок или по-нисък дял клиенти с *Висока* удовлетвореност за тази категория ще бъде предложено удовлетворение в сравнение с 22%. По същия начин ще бъдат предложени сегменти за всяка от другите категории (*Ниска* и *Среден*), ако са статистически значими.
...
Изберете предложен сегмент, за да прегледате подробностите за това предложение, включително сравнение на средната стойност и броя членове на сегмента. Можете също да прегледате стойностите или правилата на атрибутите, които AI моделът е научил да предлага избрания сегмент.
