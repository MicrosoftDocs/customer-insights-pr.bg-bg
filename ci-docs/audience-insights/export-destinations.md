...
Графиците за износ зависят от състоянието на вашата среда. Ако има актуализации на [зависимости](system.md#refresh-policies) в ход, когато трябва да започне планиран износ, системата първо ще завърши зависимостите и след това ще стартира експортирането. Можете да видите кога за последен път е бил опреснен износ в колона **Опресняване**.
