...
1. Вашата организация има [екземпляр, настроен в Microsoft Dataverse](/ai-builder/build-model#prerequisites) и е в същата организация като "Аналитични данни за клиенти".

2. Вашата среда за проницателност на аудиторията е прикрепена към Dataverse ви екземпляр.
...
1. В статията за аудиторията отидете на **Сегменти** и изберете плочката **Профили**.
...
1. В статията за аудиторията отидете на **Разузнаване** > **Прогнози** > **Моите прогнози**.
...
След като сте създали прогноза, можете да персонализирате модела в AI Builder, за да увеличите ефективността му.  
...
5. Актуализирайте модела в AI Builder. [Научете повече за управлението на модели в AI Builder](/ai-builder/manage-model#retrain-and-republish-existing-models).

Следващото изпълнение на прогнозата ще използва създадения от вас актуализиран модел.

> [!NOTE]
> Новите модели, създадени в AI Builder, няма да се показват в статистика за аудиторията, освен ако моделът е създаден от изброените по-горе преживявания.
...
Ако не можете да завършите процеса на Dataverse на прикачване поради грешка, можете да опитате да завършите процеса ръчно. Има два известни проблема, които могат да възникнат в процеса на прикачване:
