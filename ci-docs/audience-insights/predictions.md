...
1. Вашата организация има екземпляр [създаден в Common Data Service](https://docs.microsoft.com/ai-builder/build-model#prerequisites) и е в същата организация като Customer Insights.

2. Вашата среда е привързана към вашия екземпляр на Common Data Service.

Ако [създавате нова среда](manage-environments.md), конфигурирайте я в диалоговия прозорец **Създаване на среда** и изберете **Разширени**. Ако вече сте създали среда, отидете в настройките и изберете **Разширени**. Така или иначе, в секцията **Използване на прогнози** въведете URL адрес на екземпляр на Common Data Service, към който искате да прикачите вашата среда.
...
5. Актуализирайте модела в AI Builder. [Научете повече за управлението на модели в AI Builder](https://docs.microsoft.com/ai-builder/manage-model#retrain-and-republish-existing-models).
...
Ако не можете да завършите процеса на прикачване на Common Data Service поради грешка, можете да опитате да завършите процеса ръчно. Има два известни проблема, които могат да възникнат в процеса на прикачване:
