...
1. Вашата организация има екземпляр [създаден в Common Data Service](/ai-builder/build-model#prerequisites) и е в същата организация като Customer Insights.
