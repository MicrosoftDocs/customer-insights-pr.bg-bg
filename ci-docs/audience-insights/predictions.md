...
> [!NOTE]
> Новите модели, създадени в AI Builder, няма да се показват в прозренията на аудиторията, освен ако моделът не е създаден от изживяванията, изброени по-горе.
