...
В допълнение към унифицирания главен обект, създаден като част от кръстосаното съвпадение, процесът на дедупликация генерира и нов обект за всеки обект от реда за съвпадение, за да идентифицира дедуплицираните записи. Тези обекти могат да бъдат намерени заедно с **ConflationMatchPairs: CustomerInsights** в секцията **Система** на страницата **Обекти** с името **Deduplication_Datasource_Entity**.
...
- **Дезактивирайте правило**, за да запази правило за съвпадение, докато го изключва от процеса на съвпадение.
  ...
  > [!div class="mx-imgBorder"]
  > ![Дезактивиране на правило](media/configure-data-deactivate-rule.png "Дезактивиране на правило")
