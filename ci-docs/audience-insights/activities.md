...
1. В стъпката **Релация** конфигурирайте детайлите, за да свържете вашите данни за дейност със съответния запис на клиент. Тази стъпка визуализира връзката между обектите.  
   ...
   > [!TIP]
   > В B2B среди можете да избирате между обекти на акаунт и други обекти. Ако изберете обект на акаунт, пътят на връзката се задава автоматично. За други обекти трябва да дефинирате пътя на връзката над един или повече междинни обекти, докато достигнете до субект на сметка.
