...
За повече информация относно регистрацията на приложения в Azure вижте [Новият опит за регистрация на приложения на портала Azure](/azure/active-directory/develop/app-registration-portal-training-guide).
