...
ms.locfileid: "8354216"
---
# <a name="system-configuration"></a>Конфигурация на системата

За достъп до системни конфигурации в прозренията за аудитории, от лявата навигационна лента изберете **AdminSystem** > **·**, за да видите списък със системни задачи и процеси.
