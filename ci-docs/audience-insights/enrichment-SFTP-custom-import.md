...
1. Изберете [връзка](connections.md) от падащия списък. Свържете се с администратор, ако няма налична връзка. Ако сте администратор, може да създадете връзка, като изберете **Добавяне на връзка** и изберете **Персонализирано импортиране чрез SFTP** от падащото меню.

1. Изберете **Свързване с персонализирано импортиране**, за да потвърдите избраната връзка.

1.  Изберете **Напред** и въведете **името на файла** и **пътя** на файла с данни, който искате да импортирате.
...
1. Въведете валидно потребителско име, парола и URL адрес на хоста за STFP сървъра, на който се намират данните, които ще се импортират.
...
1. След като проверката приключи, връзката може да се запише чрез щракване върху **Записване**.

> [!div class="mx-imgBorder"]
   > ![Страница за конфигуриране на връзка на Experian](media/enrichment-SFTP-connection.png "Страница за конфигуриране на връзка на Experian")
