...
- Допълнителни данни (незадължително) например
    ...
    - Информация за потребителския профил на клиента
...
1. В стъпката **Допълнителни данни (незадължително)** изберете **Добавяне на данни** под **Тласък на прозренията на модела с допълнителни данни** за дейността. Изберете обекта на дейност на клиент, който предоставя информация за дейността на клиента, както е описано в [предпоставките](#prerequisites).
...
1. Добавете незадължителни данни за клиенти или изберете **Напред**.

### <a name="add-optional-customer-data"></a>Добавяне на незадължителни данни за клиентите

Изберете от 18 често използвани атрибути на клиентски профил, които да се включат като вход към модела. Тези атрибути могат да доведат до по-персонализирани, уместни и възможност за действие примерни резултати за делата Ви за използване на бизнеса.

Например: Contoso Coffee иска да предскаже доживотната стойност на клиента, за да насочи клиентите с висока стойност с персонализирано предложение, свързано с пускането на новата им машина за еспресо. Contoso използва модела CLV и добавя всички 18 атрибута на клиентския профил, за да види кои фактори влияят на клиентите им с най-висока стойност. Те намират местоположението на клиентите е най-влияят фактор за тези клиенти.
С тази информация те организират местно събитие за стартиране на еспресо машината и си партнират с местни доставчици за персонализирани оферти и специално преживяване на събитието. Без тази информация Contoso може да са изпратили само генерични маркетингови имейли и да са пропуснали възможността да персонализират за този локален сегмент от своите клиенти с висока стойност.

1. В стъпката **Допълнителни данни (незадължително)** изберете **Добавяне на данни** под Данни за **модел Boost още повече с допълнителни данни** за клиентите.

1. За **Обект** изберете **Клиент: CustomerInsights**, за да изберете унифицираната таблица с потребителски профили на клиенти, която нанася на данните от атрибута на клиента. За **ИД** на клиент изберете **System.Customer.CustomerId**.

1. Нанесете още полета, ако данните са налични във вашите единни профили на клиенти.

   :::image type="content" source="media/clv-optional-customer-profile-mapping.png" alt-text="Пример за нанесени полета за данни за потребителски профили на клиенти.":::

1. Изберете **Запиши** след съпоставяне на атрибутите, които моделът трябва да използва, за да помогне за прогнозиране на стойността по време на живот на клиента.
