...
- Потребителят, който настройва източник на данни връзка се нуждае най-малко Съхранение Blob Data Contributor разрешения на акаунта за съхранение.
