...
1. Изберете обектите, които искате да включите.
   ...
   > [!TIP]
   > За да редактирате обектите в интерфейс за редактиране на JSON, изберете **Показване на повече** > **Редактиране на файл** със схеми. Направете промени и изберете **Запиши**.
