...
Тази статия предоставя информация за това как да се въвеждат данни в Dynamics 365 Customer Insights от папка "Общ модел на данни", като използвате профила си Azure Data Lake Storage gen2.
...
- За да се удостоверите с принципал на услуга на Azure, уверете се, че е конфигуриран във вашия клиент. За повече информация вижте [Свързване с Azure Data Lake Storage gen2 акаунт с принципал на услугата на Azure](connect-service-principal.md).

- Azure Data Lake, от което искате да се свържете и поглъщате данни, трябва да бъде в същия регион на Azure като среда на Dynamics 365 Customer Insights. Не се поддържат връзки към папка на Common Data Model от хранилището с данни в различен регион на Azure. За да знаете Региона на Azure на средата, отидете **на Администратор** > **система** > **за** в Клиентски прозрения.
...
1. Можете да избирате между използване на опция, базирана на ресурси и опция, базирана на абонамент за удостоверяване. За повече информация вижте [Свързване с Azure Data Lake Storage gen2 акаунт с принципал на услугата на Azure](connect-service-principal.md). Въведете адреса **на** сървъра, изберете **влезте**, след което изберете **Напред**.
   ...
   > [!NOTE]
   > Нуждаете се от една от следните роли или в контейнера на акаунта за съхранение, за да и създадете източник на данни:
   >
