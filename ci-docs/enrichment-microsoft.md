---
title: Обогатяване на клиентски профили с марки и интереси данни от Microsoft (визуализация)
...
ms.locfileid: "9082695"
---
# <a name="enrich-customer-profiles-with-brands-and-interests-data-from-microsoft-preview"></a>Обогатяване на клиентски профили с марки и интереси данни от Microsoft (визуализация)
...
1. За да промените държавата или региона си, изберете **Промяна** до **Държава/Регион**. В панела **Настройки за страна/регион** изберете [поддържана страна/регион](#supported-countriesregions) и изберете **Прилагане**.
