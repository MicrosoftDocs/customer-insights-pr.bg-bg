...
1. Изберете, ако искате да използвате Azure private Link, за да се свържете с акаунта за съхранение и [да създадете връзката с Частна връзка](security-overview.md#set-up-an-azure-private-link) с двуетапен процес.
